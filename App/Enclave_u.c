...
sgx_status_t increase_and_seal_data(sgx_enclave_id_t eid, int* retval, size_t tid, struct sealed_buf_t* sealed_buf, unsigned int idx, struct data* ds)
{
	sgx_status_t status;
	ms_increase_and_seal_data_t ms;
	ms.ms_tid = tid;
	ms.ms_sealed_buf = sealed_buf;
	ms.ms_idx = idx;
	ms.ms_ds = ds;
